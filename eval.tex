...
\begin{enumerate}[label=\textbf{RQ\arabic*.}, leftmargin=*, align=left]
    \item How does \tia itself perform on real-world hardware designs in terms of its \emph{fundamental} capabilities, including soundness, precision, and efficiency?
